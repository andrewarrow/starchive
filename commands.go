...
func handleRetryCommand() {
	...
	// Validate that the ID looks like a YouTube video ID
	if !IsYouTubeID(id) {
...
func handleRetryVtt(id string) {
	...
	// Use the existing DownloadSubtitles function
...
func handleRetryJson(id string) {
	...
	// Use the existing DownloadJSON function
...
func handleRetryThumbnail(id string) {
	...
	// Use the existing DownloadThumbnail function
...
func handleRetryVideo(id string) {
	...
	// Temporarily set downloadVideos to true for this retry
	originalDownloadVideos := downloadVideos
	downloadVideos = true
	defer func() { downloadVideos = originalDownloadVideos }()

	// Use the existing DownloadVideo function (but skip other components)
